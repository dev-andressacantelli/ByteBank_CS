...
namespace ByteBank.Modelos
{
    ...
    public class ContaCorrente : IComparable
    {
        ...
        /// <exception cref="SaldoInsuficienteException"> Exceção lançda quando o valor de <paramref name="valor"/> é maior que o valor da propriedade <see cref="Saldo"/>. </exception>
        ...
        /* No método CompareTo preencher o contrato:
        Retornar um negativo quando a instância precede um obj;
        ...
        1° Passo: realizar um casting (conversão) de obj
        2° Passo: Começar o contrato acima! */
